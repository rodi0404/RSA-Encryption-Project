...
st.title("🔐 RSA Encryption Learning Project")
...
with tab1:
    ...
    if st.session_state.keys_generated:
        if st.session_state.show_steps:
            # Create a placeholder for animated steps
            ...
            steps = [
                ...
                },
                {
                    ...
                    **Constraint:** gcd(e, φ(n)) must equal 1
            ...
            # Clear animation and show final keys
...
with tab2:
    ...
    if not st.session_state.keys_generated:
        ...
        message = st.text_input("Enter message to encrypt:", placeholder="Type your message here")
        ...
        if encrypted_input:
            try:
                ...
                if isinstance(encrypted_list, list):
                    ...
                    st.write(f"**Encrypted:** {encrypted_list}")
